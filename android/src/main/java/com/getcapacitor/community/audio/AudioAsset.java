...
public class AudioAsset {
    ...
    private NativeAudioPlugin owner;

    AudioAsset(NativeAudioPlugin owner, String assetId, AssetFileDescriptor assetFileDescriptor, int audioChannelNum, float volume)
        throws Exception {
