...
public class AudioAsset: NSObject, AVAudioPlayerDelegate {
    ...
    var owner: NativeAudioPlugin

    let FADE_STEP: Float = 0.05
    let FADE_DELAY: Float = 0.08

    init(owner: NativeAudioPlugin, withAssetId assetId: String, withPath path: String!, withChannels channels: NSNumber!, withVolume volume: NSNumber!, withFadeDelay delay: NSNumber!) {
